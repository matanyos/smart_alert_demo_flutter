  ...
  Widget build(BuildContext context) {
    return 
      Column(
        ...
        children: [
          Center(
            child: Container(constraints: const BoxConstraints(maxWidth: 380),
              child: Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                            onPressed: () {
                              ...
                              {
                                Widget homePage = defaultTargetPlatform == TargetPlatform.iOS || defaultTargetPlatform == TargetPlatform.android
                                ? const HomePage()
